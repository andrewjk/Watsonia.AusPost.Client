...
{
	public sealed class DeleteShipmentResponse : ApiItem
	{
		/// <summary>
		...
		/// <summary>
		/// Loads a DeleteShipmentResponse from a JSON string.
		/// </summary>
		/// <param name="json">The json.</param>
		public static DeleteShipmentResponse FromJson(string json)
		{
			var serializer = new ApiSerializer();
			return serializer.FromJson<DeleteShipmentResponse>(json);
		}
	}
}
