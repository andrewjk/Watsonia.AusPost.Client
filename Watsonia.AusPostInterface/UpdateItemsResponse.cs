...
{
	public sealed class UpdateItemsResponse : ApiItem
	{
		/// <summary>
		...
		/// <summary>
		/// Loads a UpdateItemsResponse from a JSON string.
		/// </summary>
		/// <param name="json">The json.</param>
		public static UpdateItemsResponse FromJson(string json)
		{
			var serializer = new ApiSerializer();
			return serializer.FromJson<UpdateItemsResponse>(json);
		}
	}
}
