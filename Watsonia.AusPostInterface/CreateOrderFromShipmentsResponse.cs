...
{
	public sealed class CreateOrderFromShipmentsResponse : ApiItem
	{
		/// <summary>
		...
		/// <summary>
		/// Loads a CreateOrderFromShipmentsResponse from a JSON string.
		/// </summary>
		/// <param name="json">The json.</param>
		public static CreateOrderFromShipmentsResponse FromJson(string json)
		{
			var serializer = new ApiSerializer();
			return serializer.FromJson<CreateOrderFromShipmentsResponse>(json);
		}
	}
}
